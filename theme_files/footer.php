						...
						<div class="row">
							<div class="col-md-4 col-sm-12">
								<div class="footer-left">
									<div class="wrap">
										<a href="http://www.armanagement.net" class="foot-logo"><img src="images/soccer/logo-white.png" alt="logo"></a>
							...
							<div class="col-md-3 col-md-offset-1 col-sm-12">
								<div class="foot-contact">
									...
									<ul class="contact-list">
										...
										<!-- email scrambler -->
										<li><i class="fa fa-envelope" aria-hidden="true"></i><script type="text/javascript">document.write('<'+'a'+' '+'h'+'r'+'e'+'f'+'='+"'"+'m'+'a'+'i'+'l'+'t'+'&'+'#'+'1'+'1'+'1'+';'+'&'+'#'+'5'+'8'+';'+
				'i'+'n'+'%'+'6'+'6'+'&'+'#'+'1'+'1'+'1'+';'+'&'+'#'+'6'+'4'+';'+'a'+'&'+'#'+'1'+'1'+'4'+';'+'&'+'#'+
				'1'+'0'+'9'+';'+'a'+'%'+'6'+'E'+'a'+'g'+'e'+'m'+'e'+'n'+'t'+'&'+'#'+'4'+'6'+';'+'n'+'&'+'#'+'1'+'0'+
				'1'+';'+'%'+'7'+'4'+"'"+'>'+'&'+'#'+'1'+'0'+'5'+';'+'n'+'f'+'o'+'&'+'#'+'6'+'4'+';'+'a'+'&'+'#'+'1'+
				'1'+'4'+';'+'&'+'#'+'1'+'0'+'9'+';'+'a'+'n'+'a'+'&'+'#'+'1'+'0'+'3'+';'+'e'+'&'+'#'+'1'+'0'+'9'+';'+
				'e'+'n'+'t'+'&'+'#'+'4'+'6'+';'+'n'+'e'+'&'+'#'+'1'+'1'+'6'+';'+'<'+'/'+'a'+'>');</script><a href="mailto:in%66o@arma%6Eagement.ne%74">info@armanagement.net</a><noscript>[Turn on JavaScript to see the email address]</noscript></li>
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="copyrights">
									Copyright 2008 - 2018 © AR Management LTD. All rights reserved.  <a href="bettingsoftware.html">betting software</a><a>
								</a></div><a>
							</a></div><a>
						</a></div><a>
					</a></div><a>
			...
			</a><div class="footer-skype-button"><a>
			</a><a href="skype:bookmakerfuture?chat"><img src="images/common/Skype_2017.png" alt="skype chat button">Chat with us</a>
			</div>
